...
async def get_transfers(team_name: str):
    ...
    try:
        ...
        return {"transfers": result, "team": team.get("strTeam"), "logo": team.get("strTeamBadge")}
    except Exception as e:
